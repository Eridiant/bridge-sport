...
<p>переносы учитываются, завершение редактирования клик в любом месте вне блока или shift+enter</p>
<p>удалить двойные пробелы cntr+enter</p>
<p>редактирование или заполнение заявки так же через правый клик мыши</p>
