...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(AnswerUser::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SurveyMessageReply::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SurveyMessage::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Survey::className(), ['user_id' => 'id']);
    }
}
